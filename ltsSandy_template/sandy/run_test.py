...
parser.add_argument("--no_init", dest="no_init",
                    help="If set, init case will not be run during "
                         "execution of this script.",
                    action="store_true")
parser.add_argument("--finalize_init", dest="finalize_init",
                    help="If set, init case will have symlinks replaced "
